...
class SettingController extends React.Component {
    ...
    render() {
        const { onCancel, language, lock, version } = this.props;
                ...
                <div className='greyModal' ref="cell">
                    <div className="optionsWrap">
                        <div className="option" onClick={() => {
                            PopupAPI.changeState(APP_STATE.DAPP_WHITELIST);
                        }}>
                            <div className="txt">
                                <div className="span">
                        ...
                        <div className="option" onClick={() => {
                            PopupAPI.changeState(APP_STATE.NODE_MANAGE);
                        }}>
                            <div className="txt">
                                <div className="span">
                        ...
                        <div className="option" onClick={() => {
                            ...
                            <div className="txt">
                                ...
                                <div className="settingWrap">
                                    {
                                        languages.map(({ name, selected, key }) => <div key={name} onClick={(e) => {
                                            e.stopPropagation();
                                            PopupAPI.setLanguage(key);
                                        }} className={'unit' + (key === language ? ' selected' : '')}>{name}</div>)
                                    }
                                </div>
                            </div>
                        </div>
                        <div className="option" onClick={() => {
                            ...
                            <div className="txt">
                                <div className="span">
                                    ...
                                    <div className="unit">
                                        <FormattedMessage
                                            id={autoLock.filter(({ time }) => time === lock.duration)[0].name}/>
                                    </div>
                                </div>
                                <div className="settingWrap">
                                    {
